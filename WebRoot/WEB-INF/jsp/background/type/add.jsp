...
<script type="text/javascript" src="${pageContext.request.contextPath }/js/background/typeAdd.js"></script>
												...
												<td>
													<table width="100%" border="0" cellspacing="0"
														...
														<tr>
															...
															<td width="98%" valign="bottom"><span class="STYLE1">产品类型基本信息添加</span></td>
														</tr>
													</table>
												</td>
											</tr>
							...
							<table width="100%" height="463px" cellspacing="0" cellpadding="0" class="tableStyle">
								<tr>
									<td width="100%" align="left" valign="top">
										<s:form action="typeAction_addType.action" id="form">
											<table style="margin-top: 20px;">
												<tr>
													<td class="tdStyle">类型名称：</td>
