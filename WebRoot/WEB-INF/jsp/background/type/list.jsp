...
<script type="text/javascript" src="${pageContext.request.contextPath }/js/background/typeList.js"></script>
</head>
                      ...
                      <tr>
                        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            ...
                            <td width="94%" valign="bottom"><span class="STYLE1">产品类型基本信息列表</span></td>
                          </tr>
                        </table></td>
                        <td><div align="right"><span class="STYLE1">
                          <input type="checkbox" name="checkbox1" id="checkbox1" />
                          全选      &nbsp;&nbsp;
                          <s:a action="typeAction_addUI.action" id="add"><img src="images/background/add.gif" width="10" height="10"/> 添加    &nbsp;</s:a>
              ...
              <tr>
                <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" onmouseover="changeto()"  onmouseout="changeback()">
                  <tr>
                    ...
                    <td width="5%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">产品类型编号</span></div></td>
                    <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">类型名称</span></div></td>
                    <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">父产品类型编号</span></div></td>
                    ...
                    <td width="67%"><table width="312" border="0" align="right" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="49"><div align="center">
                        	<a href="typeAction_getTypeList?pageNum=1"><img src="images/background/main_54.gif" width="40" height="15" /></a>
                        	</div>
                        </td>
                        <td width="49"><div align="center">
                        	<a href="typeAction_getTypeList?pageNum=${page.pageNum-1==0?1:page.pageNum-1}"><img src="images/background/main_56.gif" width="45" height="15" /></a>
                        </div>
                        </td>
                        <td width="49"><div align="center">
                        	<a href="typeAction_getTypeList?pageNum=${page.pageNum==page.totalPage?page.totalPage:page.pageNum+1}"><img src="images/background/main_58.gif" width="45" height="15" /></a>
                        </div>
                        </td>
                        <td width="49"><div align="center">
	                        <a href="typeAction_getTypeList?pageNum=${page.totalPage}"><img src="images/background/main_60.gif" width="40" height="15" /></a>
	                        </div>
                        </td>
