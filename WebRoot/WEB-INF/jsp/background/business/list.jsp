...
<script type="text/javascript" src="${pageContext.request.contextPath }/js/background/businessList.js"></script>
</head>
                      ...
                      <tr>
                        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            ...
                            <td width="94%" valign="bottom"><span class="STYLE1">商家基本信息列表</span></td>
                          </tr>
                        </table></td>
                        <td><div align="right"><span class="STYLE1">
                          <input type="checkbox" name="checkbox1" id="checkbox1" />
                          全选      &nbsp;&nbsp;
                          <s:a action="businessAction_addUI.action" id="add"><img src="images/background/add.gif" width="10" height="10"/> 添加    &nbsp;</s:a>
                  ...
                  <s:iterator value="#page.records">
	              	<tr bgcolor="white" align="center" style="font-size: 14px">
	              		<td width="4%" height="20" class="STYLE10"><div align="center">
	              			<!-- <input type="checkbox" name="checkbox" id='<s:property value="businessId"/>' />  -->
                    ...
                    <td width="67%"><table width="312" border="0" align="right" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="49"><div align="center">
                        	<a href="businessAction_getBusinessList?pageNum=0"><img src="images/background/main_54.gif" width="40" height="15" /></a>
                        	</div>
                        </td>
                        <td width="49"><div align="center">
                        	<a href="businessAction_getBusinessList?pageNum=${page.pageNum-1==0?1:page.pageNum-1}"><img src="images/background/main_56.gif" width="45" height="15" /></a>
                        </div>
                        </td>
                        <td width="49"><div align="center">
                        	<a href="businessAction_getBusinessList?pageNum=${page.pageNum+1==page.totalPage?page.pageNum+1:page.totalPage}"><img src="images/background/main_58.gif" width="45" height="15" /></a>
                        </div>
                        </td>
                        <td width="49"><div align="center">
	                        <a href="businessAction_getBusinessList?pageNum=${page.totalPage}"><img src="images/background/main_60.gif" width="40" height="15" /></a>
	                        </div>
                        </td>
