...
<script type="text/javascript" src="${pageContext.request.contextPath }/js/background/businessAdd.js"></script>
												...
												<td>
													<table width="100%" border="0" cellspacing="0"
														...
														<tr>
															...
															<td width="98%" valign="bottom"><span class="STYLE1">商家基本信息添加</span></td>
														</tr>
													</table>
												</td>
											</tr>
							...
							<table width="100%" height="460px" cellspacing="0" cellpadding="0" class="tableStyle">
								<tr>
									<td width="100%" align="left" valign="top">
										<s:form action="businessAction_addBusiness.action" enctype="multipart/form-data" id="form">
											<table style="margin-top: 20px;">
												...
												<tr>
													...
													<td>
														<s:select name="roleId" list="#roleList" headerKey="" headerValue="请选择..." listKey="roleId" listValue="name"></s:select>
													</td>
												</tr>
												<tr>
													...
													<td><s:textfield name="shopId"></s:textfield></td>
												</tr>
												<tr>
													<td class="tdStyle">身份证号：</td>
													<td><s:textfield name="identityId"></s:textfield></td>
													<td><label></label></td>
													<td class="tdStyle" rowspan="2">备&nbsp;&nbsp;&nbsp;&nbsp;注：</td>
													<td rowspan="2"><s:textarea cols="20" rows="2" name="description"></s:textarea></td>
												</tr>
												<tr>
											...
											<table style="margin-top: 10px; margin-left: 400px;" >
												<tr>
													<td colspan="2" align="right" style="padding-top: 30px">
														<button id="add" style="margin-right: 20px">添加</button>
