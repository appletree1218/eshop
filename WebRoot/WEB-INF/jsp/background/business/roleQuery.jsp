                      ...
                      <tr>
                        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            ...
                            <td width="98%" valign="bottom"><span class="STYLE1">商家信息按角色查询</span></td>
                          </tr>
                        </table></td>
                      </tr>
                    </table></td>
              ...
              <tr>
                <td height="30" style="border: solid 1px #A8C7CE" align="center">
                	<table width="30%" border="0" cellspacing="0" cellpadding="0">
                		<tr>
                			<s:form action="businessAction_getBusinessListByRole?pageNum=1">
				                    ...
				                    <td width="25%"><table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
				                      <tr>
				                        <td width="49"><div align="center">
				                        	<a href="businessAction_getBusinessByFuzzy?pageNum=1&key=${key}"><img src="images/background/main_54.gif" width="40" height="15" /></a>
				                        	</div>
				                        </td>
				                        <td width="49"><div align="center">
				                        	<a href="businessAction_getBusinessByFuzzy?pageNum=${page.pageNum-1==0?1:page.pageNum-1}&key=${key}"><img src="images/background/main_56.gif" width="45" height="15" /></a>
				                        </div>
				                        </td>
				                        <td width="49"><div align="center">
				                        	<a href="businessAction_getBusinessByFuzzy?pageNum=${page.pageNum==page.totalPage?page.totalPage:page.pageNum+1}&key=${key}"><img src="images/background/main_58.gif" width="45" height="15" /></a>
				                        </div>
				                        </td>
				                        <td width="49"><div align="center">
					                        <a href="businessAction_getBusinessByFuzzy?pageNum=${page.totalPage}&key=${key}"><img src="images/background/main_60.gif" width="40" height="15" /></a>
					                        </div>
				                        </td>
