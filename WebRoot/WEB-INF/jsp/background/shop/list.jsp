...
<script type="text/javascript" src="${pageContext.request.contextPath }/js/background/shopList.js"></script>
</head>
                      ...
                      <tr>
                        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            ...
                            <td width="94%" valign="bottom"><span class="STYLE1">店铺基本信息列表</span></td>
                          </tr>
                        </table></td>
                        <td><div align="right"><span class="STYLE1">
                          <input type="checkbox" name="checkbox1" id="checkbox1" />
                          全选      &nbsp;&nbsp;
                          <s:a action="shopAction_addUI.action" id="add"><img src="images/background/add.gif" width="10" height="10"/> 添加    &nbsp;</s:a>
                  ...
                  <s:iterator value="#page.records">
	              	<tr bgcolor="white" align="center" style="font-size: 14px">
	              		<td width="4%" height="20" class="STYLE10"><div align="center">
	              			<!-- <input type="checkbox" name="checkbox" id='<s:property value="shopId"/>' />  -->
	              			<s:checkbox name="checkbox"></s:checkbox>
	                    </div></td>
	              		<td id="shopId"><s:property value="shopId"/></td>
	              		...
	              		<td>
	              			<s:if test="status.statusId==2">
		              			<button>审核</button>
		              			<s:select name="status" list="#statusList" listKey="statusId" listValue="name" cssStyle="display:none"></s:select>
		              			<s:label name="success" cssStyle="display:none" value="审核成功"></s:label>
	              			</s:if>
	              			<s:else>
	              				<s:label>无</s:label>
	              			</s:else>
                    ...
                    <td width="67%"><table width="312" border="0" align="right" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="49"><div align="center">
                        	<a href="shopAction_getShopList?pageNum=1"><img src="images/background/main_54.gif" width="40" height="15" /></a>
                        	</div>
                        </td>
                        <td width="49"><div align="center">
                        	<a href="shopAction_getShopList?pageNum=${page.pageNum-1==0?1:page.pageNum-1}"><img src="images/background/main_56.gif" width="45" height="15" /></a>
                        </div>
                        </td>
                        <td width="49"><div align="center">
                        	<a href="shopAction_getShopList?pageNum=${page.pageNum==page.totalPage?page.totalPage:page.pageNum+1}"><img src="images/background/main_58.gif" width="45" height="15" /></a>
                        </div>
                        </td>
                        <td width="49"><div align="center">
	                        <a href="shopAction_getShopList?pageNum=${page.totalPage}"><img src="images/background/main_60.gif" width="40" height="15" /></a>
	                        </div>
                        </td>
