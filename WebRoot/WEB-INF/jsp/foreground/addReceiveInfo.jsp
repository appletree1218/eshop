...
<html>
  <head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath }/js/foreground/addReceiveInfo.js"></script>
	<script type="text/javascript" src="${pageContext.request.contextPath }/js/area.js"></script>
  </head>
  
  <body>
  	<s:form action="receiveInfoAction_add.action">
	<table align="center" width="100%">
		<tr>
			<td colspan="2">
				<h3 style="background-color: #7F7F7F;color: white;">新增收货人信息</h3>
			</td>
		</tr>
		<tr>
